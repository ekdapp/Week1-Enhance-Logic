...
function solveQuestions() {
    ...
    return `\nSorry sir, saya udh nyoba buat functionnya sendiri tapi sulit. \nsaya ngerti cara kerja algoritmanya dan masing2 fungsi serta variabel yang ada \nkarna banyak liat resource lain, \ntapi sulit implementasi jadi code langsung. \njadi saya copas code dari repo dengan ketik manual :u`
}

// Menjalankan solusi
console.log(solveQuestions())